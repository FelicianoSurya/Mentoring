<footer class="py-3 px-3">
    <div class="d-flex justify-content-between align-items-center p-1 p-lg-5">
        <div class="d-flex justify-content-lg-start justify-content-center align-items-center">
            <img src="{{ asset('Images/Logo/logo_footer.png') }}" class="logo" alt="logo-footer">
            <h1 class="ms-lg-5 ms-2 bold">Mentoring UMN 2022</h1>
        </div>
        <div>
            <img src="{{ asset('Images/Footer/logo_umn_footer.png') }}" id="akreditasi" class="desktop" alt="">
        </div>
    </div>
    <div class="row w-100 mt-lg-0 mt-3">
        <div class="col-12 px-lg-5 px-3 col-lg-3 d-flex flex-column">
            <h3 class="bold">About Mentoring</h3>
        ...
        <div class="col-12 px-lg-5 px-3 mt-lg-0 mt-4 col-lg-4 d-flex flex-column">
            ...
            <p class="mt-2 address"><b>Universitas Multimedia Nusantara</b> Jl. Scientia Boulevard, Gading Serpong, Tangerang Banten - 15811, Indonesia</p>
        </div>
    ...
    <div class="row w-100 mt-3">
        <div class="d-flex justify-content-center align-items-center">
            <img src="{{ asset('Images/Footer/credit_sign.png') }}" alt=""><p class="m-0 ms-2">2022 Website Mentoring UMN</p>
        </div>
    </div>
</footer>